...
<body>
    ...
    <br><br><br>
    <!-- Update Form -->
    <form id="updateForm" method="post" action="updateMb.php">
        <h2>- - Update - -</h2>
        <label for="nume_update">Nume:</label>
        <input type="text" id="nume_update" name="nume" required><br>

        <label for="prenume_update">Prenume:</label>
        <input type="text" id="prenume_update" name="prenume" required><br>
    ...
    <br><br><br>
    <!-- Delete Form -->
    <form id="deleteForm" method="post" action="deleteMb.php">
        <h2>- - Delete - -</h2>
        <label for="telefon_delete">Telefon</label>
        <input type="tel" id="telefon_delete" name="telefon" required><br>
